...
function generateRandomChar(value) {
	...
	switch (value) {
		case "uppercase":
			character = getRandom(65, 90); // Random uppercase letter (A-Z)
			break;
		case "lowercase":
			character = getRandom(97, 122); // Random lowercase letter (a-z)
			break;
		case "number":
			character = getRandom(48, 57); // Random number (0-9) as char
			break;
		case "symbol":
